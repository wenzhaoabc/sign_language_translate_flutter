...
class TextStyles {
  ...
  static const TextStyle appBarTitle = TextStyle(fontSize: 20, color: Colours.text);
  static const TextStyle dark_appBarTitle = TextStyle(fontSize: 20, color: Colours.dark_text);
}
